...
// 	// On initialise le panier avec ce qui est dans le localStorage (pour ne pas le perdre au rafraîchissement)
...
// 		setCart((prevCart) => {
// 			// On vérifie si le plat est déjà dans le panier
// 			const existingItem = prevCart.find((item) => item.id === plat.id);

// 			if (existingItem) {
// 				// S'il y est, on augmente juste la quantité
...
// 			}
// 		});
// 		setIsCartOpen(true); // On ouvre le tiroir visuel du panier
// 	};
...
// 		(total, item) => total + parseFloat(item.prix) * item.quantity,
// 		0,
// 	);
...
// // 3. Un petit hook personnalisé pour utiliser le panier facilement partout
