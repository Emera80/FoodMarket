...
//   Cherry,
//   LogOut,
//   ShieldCheck // <-- Nouvel icône pour l'admin
// } from 'lucide-react';
...
//   // NOUVEAU : État pour le rôle de l'utilisateur
...
//               {/* Bouton Profil classique */}
//               <Link to="/profile" className='userIcon flex items-center gap-2 rounded-xl bg-gray-100 px-4 py-2 text-gray-700 font-bold hover:bg-gray-200 transition-colors cursor-pointer border border-gray-200'>
//                   {userAvatar ? (
...
//               {/* Bouton Déconnexion */}
//               <button onClick={handleLogout} className="p-2 text-gray-400 hover:text-red-500 transition-colors rounded-xl hover:bg-red-50" title="Se déconnecter">
//                 <LogOut size={20} />
//               </button>
//             </div>
//           ) : (
