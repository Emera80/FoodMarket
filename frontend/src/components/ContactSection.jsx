...
export default function ContactSection() {
  ...
  return (
    <section className="mx-3 sm:mx-[20px] mt-4 sm:mt-6">
      <motion.div
        className="w-full bg-white rounded-2xl sm:rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: "-100px" }}
        transition={{ duration: 0.8, ease: "easeOut" }}
      >
        ...
        {/* --- PANNEAU DROIT : Formulaire --- */}
        <div className="w-full lg:w-3/5 p-6 sm:p-10 md:p-12 lg:p-16 bg-white flex flex-col justify-center">
